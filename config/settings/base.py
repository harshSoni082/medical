...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///medical")
}
...
LOCAL_APPS = [
    ...
    "medical.core.apps.CoreConfig",
    "medical.diagnosis.apps.DiagnosisConfig"
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "templates"), str(ROOT_DIR/'build')],
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "medical.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "medical.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "medical.users.adapters.SocialAccountAdapter"
...
ALLOWED_HOSTS = ['cxd-app.herokuapp.com', '127.0.0.1:8000', 'localhost']
# Your stuff...
# ------------------------------------------------------------------------------
